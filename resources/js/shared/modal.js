...
export function setupFormSubmission(formId, modalId, entityType, entityRoute) {
    ...
    form.addEventListener('submit', function(e) {
        ...
        // const submitBtn = document.getElementById('btn_modal');
...
// // Para recargar solo tabla
// // function recargarSoloTabla(itemRoute) {
// function rechargeTable(itemRoute) {
//     // Función específica por entidad
//     const reloadFunctionName = `recargarTabla${capitalizeFirst(itemRoute)}`;
//     if (typeof window[reloadFunctionName] === 'function') {
//         console.log(`🔄 Recargando tabla: ${reloadFunctionName}`);
//         window[reloadFunctionName]();
//         return;
...
//     const reloadEvent = new CustomEvent('reloadTableOnly', {
//         detail: { entityType: itemRoute, action: 'delete' }
//     });
//     document.dispatchEvent(reloadEvent);
    
//     console.log(`🔄 Evento reloadTableOnly disparado para: ${itemRoute}`);
// }
