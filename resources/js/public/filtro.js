...
//             resultadosDiv.innerHTML = `<div class="spinner-border text-primary" role="status">
//                                             <span class="visually-hidden">Cargando...</span>
//                                         </div>`;

//             // Envía la solicitud AJAX
//             axios.get('/eventos/filtrar', { // Cambia 'filtrar' a '/eventos/filtrar'
//                 params: Object.fromEntries(new FormData(filtroForm))
//             }).then(response => {
...
//         // Carga inicial de resultados (opcional)
//         cargarResultados();
//     }
// });
