        ...
        <div class="modal-content custom-modal-border">
            ...
            <div class="modal-body custom-modal-body">
                <form id="articuloForm" class="needs-validation" action="{{ route('admin.articulos.store') }}"
                    ...
                    <div class="mb-3">
                        <button type="button" class="btn custom-button custom-button-subir" id="addAuthor_articulo">
                    ...
                    <!-- Url Articulos -->
                    <div class="mb-3">
                        <label for="url_articulo" class="form-label">Artículo cientifico</label>
                        <div class="file-input-container">
                            <label class="custom-file-label custom-button custom-button-subir">
