{{-- filepath: c:\laragon\www\BlogInvestigacion\resources\views\entities\prototipos\edit.blade.php --}}
{{-- resources/views/entities/prototipos/edit.blade.php --}}
...
@section('content')
    <div class="container-fluid mt-5 flex-grow-1 d-flex flex-column">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <h1 class="text-start fw-bold">Prototipos</h1>
            </div>
        </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2 gap-2">
                        ...
                        <div class="d-flex gap-1">
                            ...
                            <button type="button" class="btn custom-button custom-button-subir" data-bs-toggle="modal"
                                data-bs-target="#prototiposModal">
    ...
    @include('entities.prototipos.modal')
    @include('components.admin.modalDelete')

@endsection

@push('scripts')
    @vite(['resources/js/entities/prototipos/edit.js'])
@endpush