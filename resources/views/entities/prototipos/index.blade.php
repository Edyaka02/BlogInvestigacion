{{-- filepath: c:\laragon\www\BlogInvestigacion\resources\views\entities\prototipos\index.blade.php --}}
{{-- resources/views/entities/prototipos/index.blade.php --}}
@extends('components.public.publicLayout')

@section('title', 'Prototipos')
...
@section('content')
    <div class="container-fluid mt-5 flex-grow-1 d-flex flex-column">
        ...
        <div class="row mb-3">
            <div class="col-12">
                <h1 class="text-start">Prototipos</h1>
                <p class="lead text-muted">Explora nuestra colección de prototipos desarrollados</p>
            </div>
        </div>
        ...
        <div class="tabla-container">
            ...
            <div class="row mb-3">
                <div class="col-12">
                    ...
                    <div id="data-results">
                        {{-- Aquí se cargará la grilla de cards con prototipos desde JavaScript --}}
                    </div>
...
@push('scripts')
    @vite(['resources/js/entities/prototipos/index.js'])
@endpush